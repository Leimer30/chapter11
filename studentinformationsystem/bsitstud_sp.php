...
echo "<tr><th>Student No</th><th>Name</th><th>Course/Yr/Sec</th><th style='text-align:center'>Action</th></tr>";
...
foreach ($pros as $pros) {
    ...
    echo "<td style='text-align:center'><a href='viewbsitsp.php?id={$pros['stud_id']}'>View</a></td>";
    echo "</tr>";
}
...
<div class="modal fade" id="form_modal" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form method="POST" action="save'bsit'stud.php">	
...
<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form method="POST" action="update'bsit'stud.php">	
					<div class="modal-header">
