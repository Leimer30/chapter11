...
<body>
		...
		<table id="table">
			<thead>
				<tr>
					...
					<th>Occupation</th>
					<th>Contact #</th>
					<th class="glyphicon glyphicon-edit"></th>
			...
			<tbody>
				<?php
					$query = mysqli_query($conn, "SELECT * FROM `students` WHERE `course`='BSOA'") or die(mysqli_connect_error());
	...
	<div class="modal fade" id="edit_modal<?php echo $fetch['stud_id']?>" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form method="POST" action="update'bsoa'stud.php">	
					...
					<div class="modal-body">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="number" name="contact" value="<?php echo $fetch['contact']?>" class="form-control" required="required"/>
							</div>
							<div class="form-group">
								<label>Father</label>
							...
							<div class="form-group">
								<label>Contact No.</label>
								<input type="number" name="cntact" value="<?php echo $fetch['cntact']?>" class="form-control" required="required"/>
							</div>
						</div>
					</div>
	...
	<div class="modal fade" id="form_modal" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form method="POST" action="save'bsoa'stud.php">	
					<div class="modal-header">
